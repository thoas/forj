...
class ContentNode(base.Model):
    ...
    legend = models.CharField(max_length=250,
                              verbose_name='Legend', null=True, blank=True)
    cover = ThumbnailerImageField(null=True, blank=True,
                                  verbose_name='Cover image')
    product_reference = models.CharField(max_length=100, null=True, blank=True,
