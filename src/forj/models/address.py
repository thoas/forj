...
class Address(base.Model):
    ...
    first_name = models.CharField(
        max_length=250, verbose_name="First name", null=True, blank=True
    )
    last_name = models.CharField(
        max_length=250, verbose_name="Last name", null=True, blank=True
    )
    business_name = models.CharField(
        max_length=250, verbose_name="Entity name", null=True, blank=True
    )
    ...
    postal_code = models.CharField(
        max_length=140, verbose_name="Postal code", null=True
    )
    phone_number = models.CharField(
        max_length=20, verbose_name="Phone number", null=True, blank=True
    )
    city = models.CharField(max_length=140, verbose_name="City", null=True)
    country = CountryField(
        blank=True, null=True, verbose_name="Country", default=settings.DEFAULT_COUNTRY
    )
