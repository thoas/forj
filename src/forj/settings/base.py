...
FORJ_CONTACT_EMAIL = "forj.info@gmail.com"
FORJ_PHONE_NUMBER = "06.42.03.80.50"
...
LOGGING = {
    ...
    "loggers": {
        ...
        "stripe": {"handlers": ["console"], "level": "DEBUG", "propagate": True},
        "forj.web": {"handlers": ["console"], "level": "DEBUG", "propagate": True},
    },
}
