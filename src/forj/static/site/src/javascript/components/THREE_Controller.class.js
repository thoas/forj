...
class THREE_Controller {
    ...
    init_loader() {
        ...
        this.assets.hdr = new THREE.TextureLoader(this.manager).load('assets/images/hdr.png')
        this.assets.shadow = new THREE.TextureLoader(this.manager).load('assets/images/shadow.png')

        this.assets.douglas_tex = new THREE.TextureLoader(this.manager).load('assets/images/textures/douglas_DIFFUSE.jpg')
        this.assets.chene_tex = new THREE.TextureLoader(this.manager).load('assets/images/textures/chene_DIFFUSE.jpg')
        this.assets.metal_tex = new THREE.TextureLoader(this.manager).load('assets/images/textures/metal_DIFFUSE.jpg')
        this.assets.none_tex = new THREE.TextureLoader(this.manager).load('assets/images/textures/none_DIFFUSE.png')
    ...
    init_event() {
        ...
        //     let event = evt.touches[0]

        //     that.mouse.x = (event.clientX / that.width - .5) * .8
        //     that.mouse.y = 0
    ...
    update() {
        ...
        if (this.table != undefined) { this.table.update() }
        for (var i = 0; i < this.bancs.length; i++) {
            this.bancs[i].update()
        }
