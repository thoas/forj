...
class Table {
    ...
    init_feets(){
          ...
          let feet_geom = new THREE.BoxBufferGeometry( .8, 11, .8 )
          for (var i = 0; i < 4; i++) {
              ...
              let sub_frame_geom = new THREE.BoxBufferGeometry( 5.5, .42, .5 )
    ...
    init_frame(){
        ...
        let frame_geom = new THREE.BoxBufferGeometry( 20.5, .2, .5 )
        let frame_geom_2 = new THREE.BoxBufferGeometry( 16, .42, .1 )
        ...
        for (var i = 0; i < 4; i++) {
            ...
            temp_frame_2.position.y = .2
            temp_frame_2.position.z = .25
    ...
    init_desk(){
        let desk_geom = new THREE.BoxBufferGeometry( 20.5, .6, 20.5 )
    ...
    resize(){
        ...
        this.desk.position.y = (10 * this.height / 100) + .7
    ...
    change_material(mat){
        if (!this.outside) {
            TweenMax.to(this.desk.material, .4, {
                opacity: 0,
                ease: Power1.ease,
                onComplete: () => {
